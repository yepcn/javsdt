...
try:
    ...
    config_settings.set("公式元素", "”标题“末尾保留演员姓名？", "否")
    config_settings.add_section("收集nfo")
    config_settings.set("收集nfo", "是否收集nfo？", "是")
    config_settings.set("收集nfo", "title的格式", "车牌+空格+标题")
    ...
    config_settings.set("重命名视频文件", "重命名视频文件的格式", "车牌+空格+标题")
    ...
    config_settings.set("下载封面", "fanart的格式", "视频+-fanart.jpg")
    config_settings.set("下载封面", "poster的格式", "视频+-poster.jpg")
    ...
    config_settings.set("百度翻译API", "是否启用翻译？", "否")
